...
void batch_processor::process_directories(const std::vector<std::filesystem::path>& directories, 
...
void batch_processor::process_file(const std::filesystem::path& file_path, symbol_database& database) {
...
std::string batch_processor::read_file(const std::filesystem::path& path) const {
